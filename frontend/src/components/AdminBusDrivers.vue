...
export default {
  data: () => ({
    ...
    headers: [
        ...
        { text: "n identification", value: "identification_number"},
  ...
  methods: {
    initialize() {
      axios.get("/api/function_views/driver/").then((response) => {
    ...
    deleteItemConfirm() {
      ...
      axios
        .delete(
          `/api/function_views/driver/${this.currentItem.id}/`,
          self.editedItem
        )
        .then((response) => {
          this.initialize();
    ...
    save() {
      if (this.editedIndex > -1) {
        ...
        let self = this;
        axios
          .post(`/api/function_views/driver/`, self.editedItem)
          .then((response) => {
            this.initialize();
          });
      }
